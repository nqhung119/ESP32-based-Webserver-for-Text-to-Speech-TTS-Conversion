...
const char* password = "QUANGHUNG119";
...
<html lang=\"en\">\
  <head>\
    ...
    <link rel='icon' type='image/x-icon' href='https://portal.ptit.edu.vn/wp-content/uploads/2016/04/favicon.png' />\
    <meta charset=\"utf-8\">\
    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\
    <link href=\"https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css\" rel=\"stylesheet\" integrity=\"sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ\" crossorigin=\"anonymous\">\
  </head>\
  <body class'vh-100' style='background-color:#70BAED;background-position: center top;background-repeat: no-repeat;padding-top: 50px; background-image: url(https://fcdn.real-debrid.com/0819/images/v9/login/background.png); font-family: Roboto, sans-serif;';>\
    <div class='col-md-8 mx-auto text-center' style='background-color: #FFFFFF; margin-top: 8rem; margin-bottom: 8rem; border-radius: 16px;'>\
      <div class='d-flex flex-column align-items-center justify-content-center pt-5 px-5';>\
        <div class='pb-5'>\
          <h1 style='color:#0D6EFD; font-weight: 900;'>Chương trình chuyển chữ số thành giọng nói</h1>\
        </div>\
        <div class='input-group input-group-lg'>\
          <span class='input-group-text' id='inputGroup-sizing-default'>\ Nhập số\
          </span>\
          <input type='text' class='form-control form-control-lg' name='msg' id='msg' placeholder='Nhập vào đây...' size=7 autofocus>\
        </div>\
        <div class='py-4'>\
          <button type=submit class=\"btn btn-primary btn-lg\" id=\"speak_button\">Đọc số</button>\
        </div>\
      </div>\
    </div>\
